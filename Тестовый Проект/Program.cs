    ...
    class Program
    {
        ...
        static void Main()
        {
            ...
            while (wait != "Стоп")
            {
                ...
                {
                    Console.Clear();
                    (int c, int cordinatey, int cordinatex, char[,] draw) = DrawMap(map);
                    

                    
                    
                    Try(cordinatey, cordinatex, map, c);
                }
        ...
        static (int, int, int, char[,]) DrawMap(char[,] map)
        {
            ...
            return (c, cordinatex, cordinatey, map);
        }
